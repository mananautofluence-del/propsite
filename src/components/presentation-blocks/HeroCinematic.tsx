  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        left: '72px', right: '72px', zIndex: 1,
      }}>
        {/* Accent rule */}
        <div style={{
          width: '56px', height: '2px',
          backgroundColor: theme.accentColor, marginBottom: '20px',
        }} />
        ...
        {data.eyebrow && (
          <div style={{
            ...
            fontSize: '12px', color: theme.accentColor,
            marginBottom: '20px', fontFamily: theme.bodyFont, fontWeight: 500,
          }}>
            {data.eyebrow}
          </div>
        )}
        ...
        {/* Bottom row: subheadline + property type pill */}
        <div style={{
          ...
          <div style={{
            ...
            border: `1px solid ${theme.accentColor}77`,
            borderRadius: '999px',
